...
from app.services.observer_decision_engine import (  # noqa: E402
    build_observer_decision,
    extract_daily_bias_from_snapshot,
    format_observer_decision_card,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Smoke test Observer Decision Engine.")
    ...
    with SessionLocal() as db:
        ...
        result = build_observer_decision(
            symbol=symbol,
    ...
    if args.card:
        print()
        print(format_observer_decision_card(result))
